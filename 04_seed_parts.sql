...
SELECT add_part('fpv','frame','iFlight','Nazgul5 V3 Frame Kit','5 inch', 4999, 118,
 '{"prop_size_max_in":5.1,"stack_mount_mm":"30.5","motor_mount_mm":"16","camera_mount":"micro","arm_thickness_mm":5,"wheelbase_mm":227,"layout":"true-x"}');
SELECT add_part('fpv','frame','TBS','Source One V5','5 inch', 3499, 132,
 '{"prop_size_max_in":5.1,"stack_mount_mm":"30.5","motor_mount_mm":"16","camera_mount":"micro","arm_thickness_mm":5,"wheelbase_mm":220,"layout":"true-x"}');
SELECT add_part('fpv','frame','Armattan','Marmotte','5 inch', 12999, 125,
 '{"prop_size_max_in":5.1,"stack_mount_mm":"30.5","motor_mount_mm":"16","camera_mount":"micro","arm_thickness_mm":6,"wheelbase_mm":222,"layout":"true-x"}');
